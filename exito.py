...
if st.button("✅ Analizar"):
    if not url_input:
        ...
        # **Eliminar la funcionalidad de exportar y copiar al portapapeles**
        # No se incluye ningún código relacionado con la generación de PDFs o la copia al portapapeles.
